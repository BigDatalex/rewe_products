...
# Constants
BASE_URL_TEMPLATE = "https://www.rewe.de/shop/api/products?market=1931147&serviceTypes=PICKUP&objectsPerPage=80&page={page}&search=%2A&debug=false&autocorrect=true&autoCompletion=true&includeSeo=true"
...
def fetch_data():
    ...
    with sync_playwright() as p:
        ...
        upload_to_gcs(BUCKET_NAME, file_path, file_path)
